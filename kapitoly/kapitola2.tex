...
\item Časť 2 popisuje voliteľné doplnky k jadru SOAP vrátane dátového modelu, kódovania, konvencie RPC a väzby na HTTP. Zhodné implementácie protokolu SOAP môžu implementovať ktorýkoľvek doplnok z časti 2. Ak sú ale doplnky implementované, potom musia zodpovedať príslušným častiam špecifikácie \cite{Versions}.
\end{itemize}
\end{itemize}
